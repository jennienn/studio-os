...
public class BookingAvailability {
    private final java.util.List<AdditionalOccupancy> additional;private final BusinessHoursRepository hours;private final BookingRepository bookings;private final BookingBlockRepository blocks;private final StaffRepository staff;
    public BookingAvailability(BusinessHoursRepository hours,BookingRepository bookings,BookingBlockRepository blocks,StaffRepository staff,java.util.List<AdditionalOccupancy> additional){this.additional=additional;this.hours=hours;this.bookings=bookings;this.blocks=blocks;this.staff=staff;}
    ...
    public void check(Studio studio,UUID staffId,Instant start,Instant end,UUID exclude){
        ...
        hours(studio,start,end);
        additional.forEach(g->g.check(studio.id,staffId,start,end));
    ...
    public void hours(Studio studio,Instant start,Instant end){
        interval(start,end);
